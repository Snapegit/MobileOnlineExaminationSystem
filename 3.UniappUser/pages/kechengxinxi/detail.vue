	...
	<view class="content">
		<view class="container" :style='{"minHeight":"100vh","width":"100%","padding":"0","position":"relative","background":"#f0f8fa","height":"auto"}'>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"padding":"24rpx 24rpx","margin":"0 auto","borderRadius":"0","flexWrap":"wrap","background":"#fff","display":"flex","width":"calc(100% - 48rpx)","height":"auto","order":"9"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 3% 20rpx 0","color":"#333","borderRadius":"8rpx","background":"#ffcc00","width":"auto","fontSize":"28rpx","minWidth":"21%","lineHeight":"80rpx","height":"80rpx"}' v-if="userid&&isAuth('kechengxinxi','选择')" @tap="onAcrossTap('kechengxuanze','','','','')" class="cu-btn bg-brown round shadow-blur" >选择</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 3% 20rpx 0","color":"#333","borderRadius":"8rpx","background":"#ffcc00","width":"auto","fontSize":"28rpx","minWidth":"21%","lineHeight":"80rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('kechengxinxi','选择')" @tap="onAcrossTap('kechengxuanze','','','','')" class="cu-btn bg-brown round shadow-blur" >选择</button>
