	...
	<div class="addEdit-block" :style='{"width":"100%","padding":"50px 0 30px 0","margin":"0","overflow-y":"auto","background":"#fff","height":"auto"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="课程描述" prop="kechengmiaoshu">
					<el-input v-model="ruleForm.kechengmiaoshu"  placeholder="课程描述" clearable  :readonly="ro.kechengmiaoshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="课程描述" prop="kechengmiaoshu">
					<el-input v-model="ruleForm.kechengmiaoshu" placeholder="课程描述" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="难度级别" prop="nandujibie">
					<el-input v-model="ruleForm.nandujibie"  placeholder="难度级别" clearable  :readonly="ro.nandujibie"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="难度级别" prop="nandujibie">
					<el-input v-model="ruleForm.nandujibie" placeholder="难度级别" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="教师信息" prop="jiaoshixinxi">
					<el-input v-model="ruleForm.jiaoshixinxi"  placeholder="教师信息" clearable  :readonly="ro.jiaoshixinxi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="教师信息" prop="jiaoshixinxi">
					<el-input v-model="ruleForm.jiaoshixinxi" placeholder="教师信息" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="选择时间" prop="xuanzeshijian">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.xuanzeshijian" label="选择时间" prop="xuanzeshijian">
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `kechengxuanze/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.kechengxuanzeCrossAddOrUpdateFlag = false;
											this.parent.search();
