	...
	<div class="addEdit-block" :style='{"width":"100%","padding":"50px 0 30px 0","margin":"0","overflow-y":"auto","background":"#fff","height":"auto"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="难度级别" prop="nandujibie">
					<el-select :disabled="ro.nandujibie" v-model="ruleForm.nandujibie" placeholder="请选择难度级别" >
						<el-option
							v-for="(item,index) in nandujibieOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="难度级别" prop="nandujibie">
					<el-input v-model="ruleForm.nandujibie"
						placeholder="难度级别" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="课程描述" prop="kechengmiaoshu">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.kechengmiaoshu" label="课程描述" prop="kechengmiaoshu">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.kechengmiaoshu}}</span>
				</el-form-item>
