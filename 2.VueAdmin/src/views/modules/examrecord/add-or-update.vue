<template>
  <div class="main-content" :style='{"width":"100%","padding":"30px","margin":"0","overflow-y":"auto","background":"#fff","height":"auto"}'>
    <!-- 列表页 -->
    <div v-if="!showFlag">
      <el-form :style='{"padding":"0"}' :inline="true" :model="searchForm" class="add-update-preview">
        <el-form-item :style='{"margin":"0 0 20px 0"}' label="在线测试">
          <el-input v-model="searchForm.papername" placeholder="在线测试名称" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}' label="测试试题">
